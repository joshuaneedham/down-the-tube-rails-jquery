    ...
    fetch('/outings.json')
      ...
      .then(outings => {
        ...
        outings.forEach(outing => {
          ...
          $('#app-container').append(outingHtml).wrapInner('<div class="d-md-flex flex-md-wrap"><div class="card-group"></div></div>')
        });
        $('#app-container').append('<div class="d-flex justify-content-around"><a class="btn btn-outline-success" href="/outings/new">New Outing</a></div>')
      })
  }) // End Outings Link
